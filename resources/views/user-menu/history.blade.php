...
@section('title','ยกเลิกการจองวิชาเรียน')

@section('content')
       
<div class="table100 ver1 m-b-110">
  <h3>ประวัติการจองวิชาเรียน</h3><br>
  <table data-vertable="ver1">
    ...
    <tbody>
      <tr class="row100">
        ...
        <td class="column100 column4" data-column="column4"><a href="#" class="btn btn-info" class="open-button" onclick="openForm()">ดูรายละเอียด</a></td>
